    ...
    var definitions, Elements, sheet, myStyleSheet, currentTransition, active = false, myPrefix =  prefix(), propeties = [
        ...
        */
        ...
        
        {
            "type": "class",
            "ID":"html",
            "CSS":"background-image: url('https://res.cloudinary.com/carousel/image/upload/v1475538924/chalkboard_1_w619v4.jpg'); background-size: 100%; -webkit-background-size: 100%;"
        },
